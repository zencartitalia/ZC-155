...
# * @version GIT: $Id: Author: DrByte  Tue Aug 28 16:03:47 2012 -0400 Modified in v1.5.5 $
#
...
INSERT INTO admin_profiles (profile_name) values ('Gestione ordini');
...
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Text banner', '', '', 'BannersAll', 'I <b>servizi</b> e la <b>consulenza</b> per approntare al meglio il tuo negozio li trovi in <a href="http://www.zen-cart.it/" target="_blank">Zen Cart Italia</a>.', 0, NULL, NULL, '2006-08-31 18:08:41', NULL, 1, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato A', 'https://www.facebook.com/zencartitalia', 'banners/zencart-2014-a.gif', 'Header_2', '', NULL, NULL, NULL, '2012-04-07 18:33:47', '2014-07-30 20:45:49', 0, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato B', 'http://twitter.com/#!/zencartitalia', 'banners/zencart-2014-b.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:46:32', '2014-07-30 20:48:13', 0, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato C', 'https://plus.google.com/115239847124335172426', 'banners/zencart-2014-c.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:47:03', '2014-07-30 20:48:00', 0, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato D', 'http://www.youtube.com/zencartitalia', 'banners/zencart-2014-d.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:47:40', '2014-07-30 20:47:41', 0, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato E', 'http://www.opzione.com/', 'banners/zencart-2014-e.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:49:08', '2014-07-30 20:49:08', 0, 1, 1, 0);


INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Nome del Negozio', 'STORE_NAME', '', 'Il nome del Negozio', '1', '1', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Proprietario', 'STORE_OWNER', '', 'Il nome del proprietario del negozio', '1', '2', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Tasso di cambio valute: Sorgente principale', 'CURRENCY_SERVER_PRIMARY', 'ecb', 'Sorgente principale dei tassi di cambio<br><br>Sorgenti aggiuntive possono essere aggiunte via plugin.', '1', '55', 'zen_cfg_pull_down_exchange_rate_sources(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Tasso di cambio valute: Sorgente alternativa', 'CURRENCY_SERVER_BACKUP', 'boc', 'Sorgente principale dei tassi di cambio<br><br>Sorgenti aggiuntive possono essere aggiunte via plugin.', '1', '55', 'zen_cfg_pull_down_exchange_rate_sources(', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Link Paginatore Prec./Succ. (Desktop)', 'MAX_DISPLAY_PAGE_LINKS', '5', 'Numero del \'numero\' di link usati per i set di pagine (Desktop)', '3', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Link Paginatore Prec./Succ. (Mobile)', 'MAX_DISPLAY_PAGE_LINKS_MOBILE', '3', 'Numero del \'numero\' di link usati per i set di pagine (requisito: il template in uso deve supportare impostazioni specifiche per la versione mobile)', '3', '3', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('SMTP Email Mail Server Port', 'EMAIL_SMTPAUTH_MAIL_SERVER_PORT', '25', 'Inserisci il numero IP della porta su cui opera il mailserver SMTP.<br />Richiesto solamente se stai utilizzando la Autenticazione SMTP per le email.<br><br>Default: 25<br>Valori tipici:<br>25 - normal unencrypted SMTP<br>587 - encrypted SMTP<br>465 - older MS SMTP port', '12', '101', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Invia Email', 'SEND_EMAILS', 'true', 'Invia Email? Normalmente è impostato a true. <br>Impostalo a false per farein modo che non sia inviata alcuna e-mail. Ad esempio se stai lavorando su una copia offline dello store.', '12', '5', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Attiva carta di credito - Debit', 'CC_ENABLED_DEBIT', '0', 'Accetta carta di debito 0= no 1= si<br>NOTA: al momento questa funzionalità non è completamente integrata', '17', '9', 'zen_cfg_select_option(array(\'0\', \'1\'), ', now());
...
# CSS Buttons switch
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('Pulsanti CSS', 'IMAGE_USE_CSS_BUTTONS', 'Yes', 'Pulsanti CSS<br />Usa pulsanti CSS al posto delle immagini (GIF/JPG) ?<br />Gli stili di rappresentazione dei pulsanti devono essere definiti nello stylesheet se vuoi abilitare questa opzione.', '19', '147', NULL, now(), NULL, 'zen_cfg_select_option(array(\'No\', \'Yes\'), ');
...
INSERT INTO configuration_group VALUES (25, 'Gestione Pagine', 'Settaggio Pagine Extra', '25', '1');
...
INSERT INTO project_version (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch1, project_version_patch1_source, project_version_patch2, project_version_patch2_source, project_version_comment, project_version_date_applied) VALUES (1, 'Zen-Cart Main', '1', '5.5e', '', '', '', '', 'Nuova installazione', now());
INSERT INTO project_version (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch1, project_version_patch1_source, project_version_patch2, project_version_patch2_source, project_version_comment, project_version_date_applied) VALUES (2, 'Zen-Cart Database', '1', '5.5', '', '', '', '', 'Nuova installazione', now());
INSERT INTO project_version_history (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES (1, 'Zen-Cart Main', '1', '5.5e', '', 'Nuova installazione v155e', now());
INSERT INTO project_version_history (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES (2, 'Zen-Cart Database', '1', '5.5', '', 'Nuova installazione v155e', now());

##### End of SQL setup for Zen Cart 155 italiana.
