...
define('TEXT_CONDITIONS_DESCRIPTION', '<span class="termsdescription">Seleziona la casella seguente per accettare le Condizioni di vendita. Se vuoi (ri)leggerle, clicca <a href="' . zen_href_link(FILENAME_CONDITIONS, '', 'SSL') . '" target="_blank"><span class="pseudolink">>QUI</span></a>.');
