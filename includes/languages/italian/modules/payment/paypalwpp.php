...
'<font color="green"><hr /><strong>Requisiti:</strong></font><br /><hr />*<strong>CURL</strong> viene utilizzato per comunicazioni in uscita con il gateway sulle porte 80 e 443, quindi deve essere attivo nel server che ti ospita ed essere in grado di utilizzare SSL.)<br /><hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_PAYPAL_DECLINED', 'Siamo spiacenti. Paypal ha rifiutato la transazione e ci ha avvisto di comunicarti di contattare il Servizio assistenza di Paypal per avere maggiori informazioni. Per completare il tuo acquisto, ti preghiamo di scegliere un diverso metodo di pagamento.');
