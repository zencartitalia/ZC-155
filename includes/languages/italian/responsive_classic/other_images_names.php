...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Rimuovi le notifiche per questo prodotto.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Mandami notifiche per aggiornamenti su questo prodotto.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Scrivi una recensione su questo prodotto.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Chiamaci per conoscere il prezzo.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Torniamo subito! Stiamo aggiornando il sito, saremo di ritorno al più presto.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'ACCOUNT IN ATTESA DI APPROVAZIONE ...');
