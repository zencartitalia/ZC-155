...
define('TEXT_CONTACT_STORE_OWNER', 'Per informazioni o problemi scrivi al <a href="' . zen_href_link(FILENAME_CONTACT_US, '', 'SSL') . '" name="linkContactUs">servizio clienti</a>.');
...
define('HEADING_ORDER_HISTORY', 'Cronologia stati ordine e Commenti');
define('TEXT_NO_COMMENTS_AVAILABLE', 'Nessun commento presente.');
