...
define('TEXT_AUTHORIZATION_PENDING_CHECKOUT', 'Acquisto non consentito - Account in attesa di approvazione');
...
// misc
  define('COLON_SPACER', ':&nbsp;&nbsp;');
  define('PAYMENT_JAVASCRIPT_DISABLED', 'Non possiamo procedere con l\'ordine poichè javascript è disabilitato. Devi attivarlo per proseguire.');
