 ...
 * @version Id: italian.php 2015-01-05 12:48 Author: Paolo De Dionigi aka Spike00 Modified in v1.5.5
*/
...
define('TEXT_CHECK_ALL', 'Seleziona tutti');
define('TEXT_UNCHECK_ALL', 'Deseleziona tutti');
define('NONE', 'Nessuno');
define('TEXT_UNKNOWN', 'Sconosciuto');
...
define('TEXT_NO_ORDER_HISTORY', 'Storico ordini non presente');
...
define('TEXT_VERSION_CHECK_BUTTON', 'Cerca nuove versioni');
define('TEXT_BUTTON_RESET_ACTIVITY_LOG', 'Consulta log attività');
...
define('ERROR_FILE_NOT_REMOVEABLE', 'Errore: impossibile eliminare il file specificato. Devi procedere via FTP a causa di limitazioni del server sui permessi.');
define('WARNING_SESSION_AUTO_START', 'Attenzione: session.auto_start è abilitato - disabilita questa feature PHP in php.ini (può essere necessario riavviare il server).');
define('WARNING_DOWNLOAD_DIRECTORY_NON_EXISTENT', 'Attenzione: non esiste la cartella dei prodotti in download: ' . DIR_FS_DOWNLOAD . '. I prodotti in download non funzioneranno finchè questa cartella non sarà corretta.');
define('WARNING_SQL_CACHE_DIRECTORY_NON_EXISTENT', 'Attenzione: non esiste la cartella della cache SQL: ' . DIR_FS_SQL_CACHE . '. il caching di SQL non funzionerà finchè questa cartella non verrà creata.');
define('WARNING_SQL_CACHE_DIRECTORY_NOT_WRITEABLE', 'Attenzione: è impossibile scrivere nella cartella della cache SQL: ' . DIR_FS_SQL_CACHE . '. il caching di SQL non funzionerà finchè non saranno settati correttamente i permessi di scrittura su questa cartella.');
...
define('TEXT_VERSION_CHECK_NEW_VER','<span class="alertVersionNew">Nuova Versione Disponibile:</span> V');
define('TEXT_VERSION_CHECK_NEW_PATCH','<span class="alertVersionNew">Nuova PATCH Disponibile:</span> V');
...
define('TEXT_PRICED_BY_ATTRIBUTES', 'Prezzato con attributi');
...
define('TEXT_SELECT_MAIN_DIRECTORY', 'Cartella immagini principale');
...
define('TEXT_INFO_CURRENCY_UPDATED', 'Il tasso di cambio per %s (%s) è stato aggiornato a %s via %s.');
define('ERROR_CURRENCY_INVALID', 'Errore: Il tasso di cambio per %s (%s) non è stato aggiornato via %s. Controlla che sia corretto il codice valuta.');
define('WARNING_PRIMARY_SERVER_FAILED', 'Attenzione: Il server principale dei tassi di cambio (%s) non funziona per %s (%s) - provo con il server secondario.');
