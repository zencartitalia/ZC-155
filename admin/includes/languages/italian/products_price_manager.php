...
define('TEXT_PRICE_NET', 'Prezzo (Netto)');
define('TEXT_PRICE_GROSS', 'Prezzo (Lordo)');
...
define('TEXT_SPECIALS_SPECIAL_PRICE', 'Prezzo Promozione:');
define('TEXT_SPECIALS_SPECIAL_PRICE_NET', 'Prezzo Promozione: (Netto)');
define('TEXT_SPECIALS_SPECIAL_PRICE_GROSS', 'Prezzo Promozione: (Lordo)');
