 ...
 * @version $Id: orders.php 6214 2007-04-17 02:24:25Z sandrocarniel modificato in v1.5.5 $
 */

define('HEADING_TITLE', 'Ordini');
define('HEADING_TITLE_DETAILS', 'Dettagli ordine');
...
define('HEADING_TITLE_SEARCH_ALL','Cerca: ');
define('HEADING_TITLE_SEARCH_PRODUCTS','Cerca prodotto: ');
define('TEXT_RESET_FILTER', 'Elimina filtro ricerca');
...
define('ENTRY_CUSTOMER_ADDRESS', 'Indirizzo cliente:<br><i class="fa fa-2x fa-user"></i>');
define('ENTRY_SOLD_TO', 'VENDUTO A:');
define('ENTRY_DELIVERY_TO', 'Consegnare a:');
define('ENTRY_SHIP_TO', 'SPEDIRE A:');
define('ENTRY_SHIPPING_ADDRESS', 'Indirizzo Spedizione:<br><i class="fa fa-2x fa-truck"></i>');
define('ENTRY_BILLING_ADDRESS', 'Indirizzo Fatturazione:<br><i class="fa fa-2x fa-credit-card"></i>');
...
define('TEXT_CUSTOMER_LOOKUP', '<i class="fa fa-search"></i> Anteprima cliente');

define('TEXT_INVALID_ORDER_STATUS', '<span class="alert">(Stato ordine invalido)</span>');

define('BUTTON_TO_LIST', 'Elenco ordini');
define('SELECT_ORDER_LIST', 'Vai all\'ordine:');
