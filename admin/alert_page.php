...
<body>
  ...
  <li><?php echo ALERT_RENAME_ADMIN; ?><br /><a href="www.zen-cart.it/faq/gestione-sicurezza/134-rinominare-la-cartella-admin" target="_blank"><?php echo ADMIN_RENAME_FAQ_NOTE; ?></a></li>
  <?php  } ?>
  </ul>
  <?php if ($adminDirectoryExists) { ?>
  <br />
